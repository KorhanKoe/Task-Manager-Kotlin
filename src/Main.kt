...
fun main() {
    ...
    val task1 = SingleTask("Task 1", "Beschreibung Task 1", LocalDate.of(2024, 9, 6), Status.TODO, 2)
    val task2 = SingleTask("Task 2", "Beschreibung Task 2", LocalDate.of(2024, 8, 8), Status.DOING)
    val task3 = RecurringTask("Task 3", "Beschreibung Task 3", LocalDate.of(2024, 9, 12), Status.DONE, 6, 2, 1)
    val task4 = RecurringTask("Task 4", "Beschreibung Task 4", LocalDate.of(2024, 8, 11), Status.DOING, 7, 9, 5)
    val task5 = SingleTask("Task 5", "Beschreibung Task 5", LocalDate.of(2024, 9, 1), Status.DOING, 9, 2)
    val task6 = SingleTask("Task 6", "Beschreibung Task 6", LocalDate.of(2024, 8, 8), Status.DONE, 18, 9)
    val task7 = SingleTask("Task 7", "Beschreibung Task 7", LocalDate.of(2024, 8, 7), Status.DOING, 14, 10)
    val task8 = SingleTask("Task 8", "Beschreibung Task 8", LocalDate.of(2024, 9, 12), Status.TODO, 12, 10)
    val task9 = SingleTask("Task 9", "Beschreibung Task 9", LocalDate.of(2024, 8, 5), Status.DOING, 18, 7)

    // Erstellen von Projekten
    val project1 = Project("Projekt 1", "Beschreibung Projekt 1", LocalDate.of(2024, 8, 10), Status.TODO, mutableListOf(task1, task2))
    val project2 = Project("Projekt 2", "Beschreibung Projekt 2", LocalDate.of(2024, 8, 13), Status.DOING, mutableListOf(task3, task4))
    val project3 = Project("Projekt 3", "Beschreibung Projekt 3", LocalDate.of(2024, 8, 6), Status.DONE, mutableListOf(task5, task6, task7, task8, task9))
    ...
    //-------------------------------------------------------------------
    project1.checkTasks(LocalDate.of(2024,6,10))
    project2.checkTasks(LocalDate.of(2024,5,13))
    //project3.checkTasks(LocalDate.of(2024,6,5))   //Wirft Exception aus

    // Fortschrittsberechnung eines Gesamtprojekts
    println("-------------------------------------------------------------------")
    val taskManager = mutableListOf(task1, task2, task3, task4, task5, task6, task7, task8)
    val projectAll = Project("Projekt 4", "Beschreibung Projekt 4", LocalDate.of(2024,6,7), Status.TODO, taskManager)
